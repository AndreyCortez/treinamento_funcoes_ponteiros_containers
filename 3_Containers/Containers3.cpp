...
// list se assemelha bastante com a estrutura de dados linked list
...
int main(int argc, char *argv)
{
    ...
    // Ao inves de pensarmos numa lista como fila de itens na memoria 
    // devemos pensar nela como uma como um grafo, onde cada item do grafo
    // possui duas setas, uma apontando para o endereco anterior da lista
    // e outra apontando para o endereco exterior
    // isso faz com que as listas seja muito facil inserir itens na lista
    // mas torna mais lento o processo de achar o conteudo de algum index
